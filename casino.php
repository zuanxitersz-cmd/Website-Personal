...
$date = date('Y-m-d');
$stat = mysqli_query($conn,"INSERT INTO `tb_stat` (`ip`, `date`, `hits`, `page`, `user`) VALUES ('$ip', '$date', 1, 'Casino', '$pengguna')") or die (mysqli_error());
...
<head>
  ...
  <title>Casino | <?php echo $s0['instansi']; ?></title>
...
<body>
  ...
  <div id="wrapper">
    ...
    <section class="mt-2">
      <div class="container">
        <div class="breadcrumb">
          ...
          <span class="ml-2" style="color: #FFB302;">Casino</span>
          <?php } else { ?>
          <a href="<?php echo $urlweb; ?>/casino/" class="ml-2 mr-2">Casino</a> 
          <i class="fas fa-chevron-right" style="font-size: 10px; margin-top: 6px;"></i>
    ...
    <section class="mt-2 mb-3">
      <div class="container">
        <?php if(!isset($_GET['slug'])){ ?>
        <div class="gameListCasino">
          <div class="gameListCasinoColoumn">
            <a href="<?php echo $urlweb; ?>/casino/BigGaming">
              <div style="width: 100%; height: 300px!important; background: url('<?php echo $urlweb; ?>/upload/BigGaming.gif') no-repeat #481c5f; background-size: 100% 100%; background-position: center center; border: 1px solid rgb(255,255,255,0.5);">
                <div style="position: relative; bottom: -270px; left: 0px; z-index: 1; width: auto; height: 30px; line-height: 20px; background: rgb(0,0,0,0.5); padding: 3px;">
          ...
          <div class="casinoListColoumn">
            <a href="<?php echo $urlweb; ?>/casino/Evolution">
              <div style="width: 100%; height: 300px!important; background: url('<?php echo $urlweb; ?>/upload/evo.gif') no-repeat #481c5f; background-size: 100% 100%; background-position: center center; border: 1px solid rgb(255,255,255,0.5);">
                <div style="position: relative; bottom: -270px; left: 0px; z-index: 1; width: auto; height: 30px; line-height: 20px; background: rgb(0,0,0,0.5); padding: 3px;">
          ...
          <div class="casinoListColoumn">
            <a href="<?php echo $urlweb; ?>/casino/DreamGaming">
              <div style="width: 100%; height: 300px!important; background: url('<?php echo $urlweb; ?>/upload/dg.gif') no-repeat #481c5f; background-size: 100% 100%; background-position: center center; border: 1px solid rgb(255,255,255,0.5);">
                <div style="position: relative; bottom: -270px; left: 0px; z-index: 1; width: auto; height: 30px; line-height: 20px; background: rgb(0,0,0,0.5); padding: 3px;">
        ...
        <?php
            ...
            $provider = $_GET['slug'];               
            $sql_3 = mysqli_query($conn,"SELECT * FROM `tb_gamelist` WHERE `provider` = '$provider' AND `datatype` = 'LC' ORDER BY cuid ASC LIMIT 12") or die(mysqli_error($conn));
            $s33 = mysqli_num_rows($sql_3);
            if($s33 == 0){
              echo '
                <img src="'.$urlweb.'/upload/icon/casino_not_found.png" class="img-fluid" style="display: block; margin: 0 auto;">
        ...
        <div class="gameList">
          ...
          <div class="gameListColoumn text-center">
            <a <?php echo $playUrl; ?>>
              <div style="width: 100%; height: 175px!important; background: url('<?php echo $urlweb; ?>/<?php echo $s3['image']; ?>') no-repeat; background-size: 100% 100%; background-position: center center; border: 1px solid #481c5f;">
                <div style="position: relative; top: 0px; left: 0px; z-index: 1; width: 40px; height: 40px; background: #071d2a; padding: 3px; border-bottom-right-radius: 50%;">
