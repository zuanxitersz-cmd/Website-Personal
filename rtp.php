...
$date = date('Y-m-d');
$stat = mysqli_query($conn,"INSERT INTO `tb_stat` (`ip`, `date`, `hits`, `page`, `user`) VALUES ('$ip', '$date', 1, 'RTP', '$pengguna')") or die (mysqli_error());
...
<head>
  ...
  <title>RTP | <?php echo $s0['instansi']; ?></title>
    ...
    <section class="mt-2">
      <div class="container">
        <div class="breadcrumb">
          ...
          <span class="ml-2" style="color: #FFB302;">RTP</span>
          <?php } else { ?>
          <a href="<?php echo $urlweb; ?>/slot/" class="ml-2 mr-2">RTP</a> 
          <i class="fas fa-chevron-right" style="font-size: 10px; margin-top: 6px;"></i>
      ...
      <div class="container">
        <div class="row">
            ...
            <div class="card p-0">
              <div class="card-body p-0">
                <ul class="nav flex-column">
                  <li class="nav-item">
                    <a href="<?php echo $urlweb; ?>/rtp/" class="nav-link<?php if(!isset($_GET['slug'])) { echo ' active'; } ?>">
                  ...
                  ?>
                  <li class="nav-item">
                    <a href="<?php echo $urlweb; ?>/rtp/<?php echo $gp['provider']; ?>" class="nav-link<?php if(isset($_GET['slug'])){ if($_GET['slug'] == $gp['provider']) { echo ' active'; }} ?>">
          ...
          <div class="col-md-10 col-sm-9 pl-1">
            ...
            <?php
              if(isset($_GET['slug'])){
                $where = "provider = '".$_GET['slug']."' AND `datatype` = 'SL' ORDER BY cuid ASC LIMIT 30";
              } 
              else {
              ...
              <div class="gameListSlotColoumn text-center">
                <a href="#">
                  <div style="width: 100%; height: 175px!important; background: url('<?php echo $s3['image']; ?>') no-repeat; background-size: 100% 100%; background-position: center center; border: 1px solid #481c5f;">
                    ...
                    <div class="progress text-center mt-2" style="position: relative; bottom: -100px; left: 0px; z-index: 1;background: rgb(255,255,255,0.5); height: 25px; border-radius: 0px;">
                      <div class="progress-bar progress-bar-striped progress-bar-animated <?php echo $warna; ?>" role="progressbar" aria-valuenow="<?php echo $random; ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $random; ?>%"><?php echo $random; ?>%</div>
                    </div>
                  </div>
            ...
            <div class="card-body p-1 pb-3">
              <div class="row">
                ...
                <div class="col-3 p-1 m-0">
                  <a class="nav-link text-center" href="<?php echo $urlweb; ?>/rtp/<?php echo $gp['provider']; ?>" style="font-size: 0.65rem;">
